...
class FavIconListPro extends StatefulWidget {
  final Favorites mydata;
  FavIconListPro(this.mydata);
  @override
  _FavIconState createState() => _FavIconState();
}

class _FavIconState extends State<FavIconListPro> {
        ...
        builder: (context, snapshot) {
          ...
          likeBuilder: (bool isLiked) {
                ...
                check().then((result) => isLiked = result);
                   ...
                   return  
                   Icon(Icons.favorite_sharp,color:isLiked? Colors.red:Colors.grey,size: 25,) ;
              });
             });
