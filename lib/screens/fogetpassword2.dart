        ...
        Container(
          decoration: BoxDecoration(
            image:DecorationImage(
              image:  AssetImage("assets/images/backgroundreset.jpg"),fit: BoxFit.cover)),
        ),Column(
        children: [
          SizedBox(
                height: height*0.2,
           ...
           child: Text('Xác Nhận',style: TextStyle(color: Colors.white,fontFamily:'Rokkitt',fontSize: 24)),
           color: Colorbtn,
           height: 50,
           minWidth: width*0.6,
