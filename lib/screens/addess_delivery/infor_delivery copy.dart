...
class InforDelivery1 extends StatefulWidget {
  String? id;
  InforDelivery1({this.id}) ;

  @override
  _InforDeliveryState createState() => _InforDeliveryState();
}

class _InforDeliveryState extends State<InforDelivery1> {
          ...
          return Column(
            ...
            children: [
              Slidable(
                  ...
                  child: InkWell(
                    onTap: (){
                      print(address[index].idAddress);
                      Navigator.pushReplacement(context,
                      
                    MaterialPageRoute(builder: (context) => DetailsOrder(mdDetail: widget.id.toString(),idAddress: address[index].idAddress,)
                    ));
                    },
                    child:Container(
                    height: 100,
